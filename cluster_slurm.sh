...
#SBATCH --ntasks=16           # Maximal benötigte Prozesszahl
#SBATCH --cpus-per-task=16 # OpenMP Threads pro Prozess
...
# -------------------- Parameter-Sweeps --------------------
NP_LIST=(1 2 4 6 8 10 12 16)             # MPI ranks
OMP_LIST=(1 2 4 6 8 10 12 16)            # OpenMP threads
